...
User_Company:SysGen:nco_processing:1.0\
xilinx.com:ip:processing_system7:5.5\
xilinx.com:ip:proc_sys_reset:5.0\
xilinx.com:user:interface_slice:1.0\
xilinx.com:ip:axi_intc:4.1\
xilinx.com:user:usr_driver:1\
...
proc create_root_design { parentCell } {
  ...
  set sig_tx_enable [ create_bd_port -dir O sig_tx_enable ]
  ...
  # Create instance: nco_processing, and set properties
  set nco_processing [ create_bd_cell -type ip -vlnv User_Company:SysGen:nco_processing:1.0 nco_processing ]
  ...
  # Create instance: usr_driver, and set properties
  set usr_driver [ create_bd_cell -type ip -vlnv xilinx.com:user:usr_driver:1 usr_driver ]

  # Create instance: usr_drv_clk_wiz, and set properties
  set usr_drv_clk_wiz [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 usr_drv_clk_wiz ]
  set_property -dict [ list \
   CONFIG.CLKOUT1_JITTER {290.478} \
   CONFIG.CLKOUT1_PHASE_ERROR {133.882} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {10.000} \
...
connect_bd_intf_net -intf_net [get_bd_intf_nets iop_pmodb_pmodb_gpio] [get_bd_intf_ports pmodb_gpio] [get_bd_intf_pins slice_pmodb_gpio/gpio]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_1_M04_AXI [get_bd_intf_pins ps7_0_axi_periph_1/M04_AXI] [get_bd_intf_pins usr_driver/distmm]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_1_M05_AXI [get_bd_intf_pins ps7_0_axi_periph_1/M05_AXI] [get_bd_intf_pins usr_driver/refresh_freq]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M08_AXI [get_bd_intf_pins nco_processing/nco_processing_s_axi] [get_bd_intf_pins ps7_0_axi_periph/M08_AXI]
  ...
  connect_bd_net -net audio_codec_ctrl_0_bclk [get_bd_pins audio_codec_ctrl_0/bclk] [get_bd_pins nco_processing/bclk_in]
  connect_bd_net -net audio_codec_ctrl_0_codec_address [get_bd_ports codec_addr] [get_bd_pins audio_codec_ctrl_0/codec_address]
  connect_bd_net -net audio_codec_ctrl_0_lrclk [get_bd_pins audio_codec_ctrl_0/lrclk] [get_bd_pins nco_processing/lrclk_in]
  connect_bd_net -net audio_codec_ctrl_0_sdata_o [get_bd_pins audio_codec_ctrl_0/sdata_o] [get_bd_pins nco_processing/sdata_in]
  ...
  connect_bd_net -net ps7_0_FCLK_CLK3 [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins iop_arduino/M18_ACLK] [get_bd_pins ps7_0/FCLK_CLK3] [get_bd_pins ps7_0/M_AXI_GP1_ACLK] [get_bd_pins ps7_0/S_AXI_HP2_ACLK] [get_bd_pins ps7_0_axi_periph_1/ACLK] [get_bd_pins ps7_0_axi_periph_1/M00_ACLK] [get_bd_pins ps7_0_axi_periph_1/M01_ACLK] [get_bd_pins ps7_0_axi_periph_1/M02_ACLK] [get_bd_pins ps7_0_axi_periph_1/M03_ACLK] [get_bd_pins ps7_0_axi_periph_1/M04_ACLK] [get_bd_pins ps7_0_axi_periph_1/M05_ACLK] [get_bd_pins ps7_0_axi_periph_1/S00_ACLK] [get_bd_pins rst_ps7_0_fclk3/slowest_sync_clk] [get_bd_pins trace_analyzer_pi/s_axi_aclk] [get_bd_pins trace_analyzer_pmodb/s_axi_aclk] [get_bd_pins usr_driver/distmm_aclk] [get_bd_pins usr_driver/refresh_freq_aclk]
  connect_bd_net -net ps7_0_FCLK_RESET0_N [get_bd_pins ps7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_fclk0/ext_reset_in] [get_bd_pins rst_ps7_0_fclk1/ext_reset_in] [get_bd_pins rst_ps7_0_fclk3/ext_reset_in] [get_bd_pins usr_drv_clk_wiz/resetn] [get_bd_pins video/system_resetn]
  ...
  connect_bd_net -net rst_ps7_0_fclk3_peripheral_aresetn [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins iop_arduino/M18_ARESETN] [get_bd_pins ps7_0_axi_periph_1/M00_ARESETN] [get_bd_pins ps7_0_axi_periph_1/M01_ARESETN] [get_bd_pins ps7_0_axi_periph_1/M02_ARESETN] [get_bd_pins ps7_0_axi_periph_1/M03_ARESETN] [get_bd_pins ps7_0_axi_periph_1/M04_ARESETN] [get_bd_pins ps7_0_axi_periph_1/M05_ARESETN] [get_bd_pins ps7_0_axi_periph_1/S00_ARESETN] [get_bd_pins rst_ps7_0_fclk3/peripheral_aresetn] [get_bd_pins trace_analyzer_pi/s_axi_aresetn] [get_bd_pins trace_analyzer_pmodb/s_axi_aresetn] [get_bd_pins usr_driver/distmm_aresetn] [get_bd_pins usr_driver/refresh_freq_aresetn]
  connect_bd_net -net sig_in_1 [get_bd_ports sig_in] [get_bd_pins usr_driver/sig_in]
  ...
  connect_bd_net -net usr_driver_sig_out [get_bd_ports sig_out] [get_bd_pins usr_driver/sig_out]
  connect_bd_net -net usr_driver_sig_tx_enable [get_bd_ports sig_tx_enable] [get_bd_pins usr_driver/sig_tx_enable]
  connect_bd_net -net usr_drv_clk_wiz_clk_out1 [get_bd_pins usr_driver/clk] [get_bd_pins usr_drv_clk_wiz/clk_out1]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C80000 [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs nco_processing/nco_processing_s_axi/reg0] SEG_nco_processing_reg0
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x83C00000 [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs usr_driver/distmm/distmm_reg] SEG_usr_driver_distmm_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x83C30000 [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs usr_driver/refresh_freq/refresh_freq_reg] SEG_usr_driver_refresh_freq_reg
...
proc available_tcl_procs { } {
   ...
   puts "#"
   puts "#    create_hier_cell_iop_arduino parentCell nameHier"
   puts "#    create_hier_cell_iop_pmoda parentCell nameHier"
   puts "#    create_hier_cell_iop_pmodb parentCell nameHier"
   puts "#    create_hier_cell_iop_rpi parentCell nameHier"
   puts "#    create_hier_cell_trace_analyzer_pi parentCell nameHier"
   puts "#    create_hier_cell_trace_analyzer_pmodb parentCell nameHier"
   puts "#    create_hier_cell_video parentCell nameHier"
   puts "#    create_hier_cell_wire_distribution_network parentCell nameHier"
   puts "#    create_hier_cell_lmb parentCell nameHier"
   puts "#    create_hier_cell_spi_subsystem parentCell nameHier"
   puts "#    create_hier_cell_timers_subsystem parentCell nameHier"
   puts "#    create_hier_cell_lmb_1 parentCell nameHier"
   puts "#    create_hier_cell_lmb_2 parentCell nameHier"
   puts "#    create_hier_cell_iic_subsystem parentCell nameHier"
   puts "#    create_hier_cell_lmb_3 parentCell nameHier"
   puts "#    create_hier_cell_spi_subsystem_1 parentCell nameHier"
   puts "#    create_hier_cell_timers_subsystem_1 parentCell nameHier"
   puts "#    create_hier_cell_hdmi_in parentCell nameHier"
   puts "#    create_hier_cell_hdmi_out parentCell nameHier"
   puts "#    create_hier_cell_rpi_i_reorder_7_0 parentCell nameHier"
   puts "#    create_hier_cell_rpi_o_reorder_7_0 parentCell nameHier"
   puts "#    create_hier_cell_rpi_t_reorder_7_0 parentCell nameHier"
